...
- Steht vor dem Transkript eine Zeile "Bekannte Begriffe", sind das Namen, die der Sprecher oft benutzt. Lautschrift-Verschreibungen davon ersetzt du durch den Begriff: "fast AP" oder "fast api" wird FastAPI, "PTest" oder "pei test" wird pytest, "Settings John" wird settings.json, "Klaut" wird Claude.
